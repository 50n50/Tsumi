...
<SettingCard title='Enable External Player' description='Tells Tsumi to open a custom user-picked external video player to play video, instead of using the built-in one.'>
  <div class='custom-switch'>
